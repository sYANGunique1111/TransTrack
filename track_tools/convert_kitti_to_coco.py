    ...
    for split in SPLITS:
        ...
        for seq in sorted(seqs):
            ...
            for i in range(num_images):
                ...
                image_info = {'file_name': 'image_02/{}/{:06d}.jpg'.format(seq_noext, i),  # image name.
            ...
            if split != 'test':
                ...
                if CREATE_SPLITTED_ANN and ('half' in split):
                    ...
                    for o in anns_out:
                        fout.write('{:d},{:d},{:d},{:d},{:d},{:d},{:d},{:d},{:d},{:d}\n'.format(
                                    ...
                                    int(o[6]), int(o[7]), int(o[8]), int(o[9])))
                    fout.close()
                '''
                ...
                for i in range(anns.shape[0]):
                    ...
                    iscrowd = 1 if category_id == -1 else 0
                    '''
